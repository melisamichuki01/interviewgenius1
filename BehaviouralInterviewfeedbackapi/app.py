...
def ask_question():
    try:
        ...
        messages = [
            {"role": "system", "content": "You are an interviewer asking behavioural questions to a candidate to know if they will be a good fit . Generate the next question based on the candidate's last answer."},
...
def get_feedback():
    try:
        ...
        messages = [
            {"role": "system", "content": "You are a professional interviewer providing feedback on a job interview, exclude the first entry.."},
        ]
