...
def ask_question():
    try:
        ...
        messages = [
            {"role": "system", "content": "You are an interviewer asking questions to a candidate for a data scientist position. Generate the next question based on the candidate's last answer."},
